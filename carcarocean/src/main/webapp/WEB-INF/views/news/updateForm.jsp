...
<body>
	<div class="page-main">
		...
		<div class="container">
			<h2 class="mt-5 mb-5">자동차 뉴스 글 수정</h2>
				<form id="update_form" action="update.do" method="post" enctype="multipart/form-data">
				<input type="hidden" name="news_num" value="${news.news_num}"> 
					<ul class="list-unstyled">
						<li class="mb-2">
							<label for="news_title" class="fs-4 mt-3 mb-2">제목</label><br>
							<input type="text" class="form-control" name="news_title" id="news_title" value="${news.news_title}" maxlength="50">
						</li>
						<li class="mt-2">
							<label for="news_content" class="fs-4 mb-2">내용</label>
							<textarea rows="20" cols="70" class="form-control" name="news_content" id="news_content">${news.news_content}</textarea>
						</li>
						<li>
							<input type="file" name="news_photo" class="form-control mt-3 mb-2" id="news_photo" accept="image/gif, image/png, image/jpeg" multiple>
