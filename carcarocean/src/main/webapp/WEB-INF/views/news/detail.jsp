...
<body>
		...
		<hr size="1" noshade="noshade" width="100%">
			<div class="mt-4 mb-4 d-flex justify-content-between align-items-center">
				<!-- 제목 -->
				<div class="text-start fs-3 mt-1">${news.news_title}</div>
				<!-- 작성일 -->
		...
		<hr size="1" noshade="noshade" width="100%">
			<div class="mt-1 mb-1 d-flex justify-content-between align-items-center">
        		...
        		<!-- 조회수 -->
        		<div class="text-end">
           			<div class="d-inline" style="margin-right: 30px;">조회수 : ${news.news_hit}</div>
        		</div>
       		</div>
			...
			<div class="text-end mb-5">
				<ul class="detail-sub list-unstyled">
					<li>
						...
						<input type="button" class="btn btn-warning text-white" value="수정" onclick="location.href='updateForm.do?news_num=${news.news_num}'">
