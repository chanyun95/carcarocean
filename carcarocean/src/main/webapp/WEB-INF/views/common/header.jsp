      ...
      <nav class="navbar navbar-expand-lg">
         <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="nav">
               <ul class="navbar-nav">
               	  <!-- 첫번째 메뉴 -->
                  <li class="nav-item dropdown"><a class="nav-link text-dark px-3 fs-4" href="#" data-toggle="dropdown">차량 구매</a>
                  ...
                  <!-- 두번째 메뉴 -->
                  <li class="nav-item dropdown"><a class="nav-link text-dark px-3 fs-4" href="#" data-toggle="dropdown">차량 판매</a>
                     <div class="dropdown-menu">
                  ...
                  <!-- 세번째 메뉴 -->
                  <li class="nav-item dropdown"><a class="nav-link text-dark px-3 fs-4" href="#" data-toggle="dropdown">커뮤니티</a>
                     <div class="dropdown-menu">
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/board/list.do">자유게시판</a>
                     </div>
                  </li>
                  <!-- 네번째 메뉴 -->
                  <li class="nav-item dropdown"><a class="nav-link text-dark px-3 fs-4" href="#" data-toggle="dropdown">고객 센터</a>
                     <div class="dropdown-menu">
                  ...
                  <c:if test="${!empty user_num && user_auth ==9}">
                   ...
                   <li class="nav-item dropdown"><a class="nav-link text-dark px-3 fs-4" href="#" data-toggle="dropdown">관리자</a>
                     <div class="dropdown-menu">
