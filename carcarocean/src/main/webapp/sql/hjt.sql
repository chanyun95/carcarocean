...
checker_num NUMBER NOT NULL,				-- 검수자 식별자
mem_num NUMBER NOT NULL,					-- 회원 식별자
...
CONSTRAINT s_re_fk2 FOREIGN KEY (checker_num) REFERENCES car (checker_num),
CONSTRAINT s_re_fk3 FOREIGN KEY (mem_num) REFERENCES member (mem_num)
);
